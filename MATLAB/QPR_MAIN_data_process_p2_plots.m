...
Bfield = [10]; %mT, define magnetic field for this plot [2.7,4.5,9.2,13.75]
Bstep=1.0; %mT, field range to find data close to the defined value (has to be > 0.1)
Tstep=0.25;
inputdata = alldata0; %define data from which the RsvT data set is created [alldata - recalc, alldata0 - origin]
...
nsig = 3;
BFieldVal = 10; %field level to plot
Tmin = 1;
Tmax = 6.0;
...
Temp = [2.5, 3, 3.5, 4, 4.5, 5, 6, 6.5, 7, 7.5, 7.75, 8, 8.25]; %mT, define magnetic field for this plot[3.25, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.25, 7.5, 7.75, 8, 8.25]
Tstep=0.05; %mT, field range to find data close to the defined value (has to be > 0.1)
Bstep=0.8;
inputdata = alldata0; %define data from which the RsvT data set is created alldata0(alldata0(:,23)<37,:)
SensN = 26; %define Temp sensor 25 - Sensor A (default), 26 - B, 27 - C, 28 - D.
...
nsig = 1;
TempVal = [4.5,6.5,7.5,7.75,8,8.25]; %field level to plot
Bmin = 0;
Bmax = 50;
