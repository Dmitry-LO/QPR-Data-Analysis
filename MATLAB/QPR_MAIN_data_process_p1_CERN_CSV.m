...
clc,clear
%===========INPUT================
Datapath1 = 'D:\nextcloud\QPR tests & Operation\2022-05-01 - CERN QPRv1 test - ARIES-QPR-HZB-B5.11 (INFN with Nb flange)'
%Datapath1 = 'D:\nextcloud\QPR tests & Operation\2022-02-25 - test #35 - ARIES B-2.13 Siegen SIS'
ArchName='CoolDownCERN.mat' %
% ArchName='CoolDown17HZB.mat' %

modes=[1] %1,2,3

Set1Data = '..\400 MHz\*RsVsB_400_2K_INFN_20220512*.csv'%'..\*41*MHz*Measurements*.txt' %411
...
procdata = readtable('D:\nextcloud\QPR tests & Operation\2022-05-01 - CERN QPRv1 test - ARIES-QPR-HZB-B5.11 (INFN with Nb flange)\800 MHz\RsVsT_800_17.8mT_INFN_20220513.csv','NumHeaderLines',3);

ExperimentData = table2array(procdata); %11,12 B; 21 Rs; 14-16 T
