clc,clear
FPath = 'D:\CERNbox\QPR tests & Operation\2022-02-25 - test #35 - ARIES B-2.13 Siegen SIS\NAData\' %

NAData=NA_f1_import(FPath)
disp(['Import operation <strong>finished</strong>']);

archname='NAData35.mat';
...
startPoints1=[4e-9 CenterF1 5e-5 103];
startPoints2=[4e-9 CenterF2 5e-5 75];
startPoints3=[4e-9 CenterF3 5e-5 62];
...
logfolder=['D:\CERNbox\QPR tests & Operation\2022-02-25 - test #35 - ARIES B-2.13 Siegen SIS\','VTSData\']
...
hold on
plot([NAData.Q1.SensB],[NAData.Q1.ShiftF_HeCorr]*1e3,'.-','LineWidth',1.0,'DisplayName','416 MHz');
