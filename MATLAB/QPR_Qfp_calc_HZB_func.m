...
function [Qfp,sigQfp]=QPR_Qfp_calc_HZB_func(modes,FPath)
MakePlot=1;
...
TraceN = inputdlg('trace number');
TraceN = str2double(cell2mat(TraceN));
sigQfp=Qfp0(TraceN,2);
Qfp=Qfp0(TraceN,1);
end
clearvars -except TraceData modes Qfp1 Qfp2 Qfp3 MakePlot sigQfp Qfp
end