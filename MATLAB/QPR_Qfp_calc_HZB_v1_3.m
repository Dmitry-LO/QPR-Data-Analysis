...
FPath1='D:\nextcloud\QPR tests & Operation\2022-04-04 - test #36 - ARIES B-3.19 Siegen SIS\Qfp1_day1\'

FPath2='D:\nextcloud\QPR tests & Operation\2022-04-04 - test #36 - ARIES B-3.19 Siegen SIS\Qfp2_day3\'%'..\Qfp2_ALL\';
...
% if ii==1
% MarkColor='[.0 0.45 .74]';%'[.0 0.45 .74]';
% elseif ii==2
% MarkColor='[.85 0.33 .10]';
% elseif ii==3
% MarkColor='[.93 0.69 .13]';
% end
...
clearvars -except TraceData modes Qfp1 Qfp2 Qfp3
